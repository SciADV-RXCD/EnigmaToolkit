...
{
    public partial class FormDERQRegrade : Form
    {
        public FormDERQRegrade()
        {
            InitializeComponent();
        }

        private void FormDERQRegrade_Load(object sender, EventArgs e)
        {
        ...
        private void button32_Click(object sender, EventArgs e)
        {
            Process OpenDocumentation = new Process()
            {
                ...
                {
                    FileName = "https://docs.google.com/document/d/1AVqnTxH1n66ATuarwuVVEqYiJImpsO3sopChHfH0Iew/edit?tab=t.0#heading=h.uw0bmjfoalrg",
        ...
        {
            this.Hide();
            FormMainRegrade MainRegrade = new FormMainRegrade();
            MainRegrade.ShowDialog();
            this.Dispose();
        }

        private void pictureBox1_Click(object sender, EventArgs e)
        {
            FormEasterEgg easterEgg = new FormEasterEgg();
